...
public class BookSellerAgent extends Agent {
  ...
  public void updateCatalogue(final String title, int price, int shipping) {
    addBehaviour(new OneShotBehaviour() {
      public void action() {
		  int totalPrice = price + shipping;
		catalogue.put(title, totalPrice);
		System.out.println(getAID().getLocalName() + ": " + title + " put into the catalogue. Price = " + totalPrice);
      }
    } );
  }
